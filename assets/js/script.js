document.getElementById('botao_menu_mobile').onclick = function() {
    ...
    if(menu_view == 'false') {
        menu_mobile.style = "animation: mostrar-menu 0.5s; z-index: 2;";
...
function Descricao() {
    ...
    if(descricao_view == 'false') {
        manual_descricao.style = "animation: ver-descricao 0.2s; width: 30%";
        manual_descricao.setAttribute('view','true');
    } else {
        manual_descricao.style = "animation: fechar-descricao 0.2s;";
